            ...
            <div class="row mb-5">
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::select('pisos_inmueble', collect(['' => 'Seleccionar...'])->union($indicador_numerico), null, ['class' => 'form-control select2', 'id' => 'pisos_inmueble']) !!}
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::select('pisos_edificio', collect(['' => 'Seleccionar...'])->union($indicador_numerico), null, ['class' => 'form-control select2', 'id' => 'pisos_edificio']) !!}
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::text('fondo', null, ['class' => 'form-control text-uppercase', 'id' => 'fondo']) !!}
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::text('area_libre', null, ['class' => 'form-control', 'id' => 'area_libre']) !!}
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::text('anios_remodelacion', null, ['class' => 'form-control', 'id' => 'anios_remodelacion']) !!}
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::text('area_patios', null, ['class' => 'form-control', 'id' => 'area_patios']) !!}
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::select('id_condicion_inmueble', collect(['' => 'Seleccionar...'])->union($condicion_inmueble), null, ['class' => 'form-control select2', 'id' => 'id_condicion_inmueble']) !!}
                    </div>
                </div>
