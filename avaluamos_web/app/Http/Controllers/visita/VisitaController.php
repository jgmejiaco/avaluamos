...
class VisitaController extends Controller
{
    ...
    public function visitaDireccion()
    {
        $idCliente = request('id_cliente', null);
        $direccionCreate = strtoupper(request('direccion_create', null));
        // $direccionCreate = request('direccion_create', null);
        ...
        return response()->json($consultaPredio);
    }
