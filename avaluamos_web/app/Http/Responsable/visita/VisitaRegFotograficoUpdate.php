...
class VisitaRegFotograficoUpdate implements Responsable
{
    ...
    public function toResponse($request)
    {
        ...
        $rfZona_ropa1 = request('rf_zona_ropa1', null);
        $rfZona_ropa2 = request('rf_zona_ropa2', null);
        $rfZona_ropa3 = request('rf_zona_ropa3', null);
        ...
        try {
            $baseFileName = ""; //nombre base para los archivos
            ...
            $editarRegFotografico = RegistroFotografico::where('id_visita',$idVisita)
                ->update([
                    ...
                    'rf_zona_ropa1' => $rfZona_ropa1,
                    'rf_zona_ropa2' => $rfZona_ropa2,
                    'rf_zona_ropa3' => $rfZona_ropa3,
