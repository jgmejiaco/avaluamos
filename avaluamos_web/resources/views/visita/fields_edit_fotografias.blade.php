            ...
            <div class="row mb-5">
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_sala1', ['class' => 'form-control', 'id' => 'rf_sala1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_sala2', ['class' => 'form-control', 'id' => 'rf_sala2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_sala3', ['class' => 'form-control', 'id' => 'rf_sala3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_comedor1', ['class' => 'form-control', 'id' => 'rf_comedor1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_comedor2', ['class' => 'form-control', 'id' => 'rf_comedor2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_comedor3', ['class' => 'form-control', 'id' => 'rf_comedor3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_cocina1', ['class' => 'form-control', 'id' => 'rf_cocina1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_cocina2', ['class' => 'form-control', 'id' => 'rf_cocina2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_cocina3', ['class' => 'form-control', 'id' => 'rf_cocina3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion1', ['class' => 'form-control', 'id' => 'rf_habitacion1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion2', ['class' => 'form-control', 'id' => 'rf_habitacion2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion3', ['class' => 'form-control', 'id' => 'rf_habitacion3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion4', ['class' => 'form-control', 'id' => 'rf_habitacion4']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion5', ['class' => 'form-control', 'id' => 'rf_habitacion5']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion6', ['class' => 'form-control', 'id' => 'rf_habitacion6']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_habitacion7', ['class' => 'form-control', 'id' => 'rf_habitacion7']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_bano1', ['class' => 'form-control', 'id' => 'rf_bano1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_bano2', ['class' => 'form-control', 'id' => 'rf_bano2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_bano3', ['class' => 'form-control', 'id' => 'rf_bano3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_patio1', ['class' => 'form-control', 'id' => 'rf_patio1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_patio2', ['class' => 'form-control', 'id' => 'rf_patio2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_patio3', ['class' => 'form-control', 'id' => 'rf_patio3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_estudio1', ['class' => 'form-control', 'id' => 'rf_estudio1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_estudio2', ['class' => 'form-control', 'id' => 'rf_estudio2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_estudio3', ['class' => 'form-control', 'id' => 'rf_estudio3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_cuarto_util1', ['class' => 'form-control', 'id' => 'rf_cuarto_util1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_cuarto_util2', ['class' => 'form-control', 'id' => 'rf_cuarto_util2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_cuarto_util3', ['class' => 'form-control', 'id' => 'rf_cuarto_util3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_pasillo1', ['class' => 'form-control', 'id' => 'rf_pasillo1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_pasillo2', ['class' => 'form-control', 'id' => 'rf_pasillo2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_pasillo3', ['class' => 'form-control', 'id' => 'rf_pasillo3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_zona_ropa1', ['class' => 'form-control', 'id' => 'rf_zona_ropa1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_zona_ropa2', ['class' => 'form-control', 'id' => 'rf_zona_ropa2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_zona_ropa3', ['class' => 'form-control', 'id' => 'rf_zona_ropa3']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_balcon1', ['class' => 'form-control', 'id' => 'rf_balcon1']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_balcon2', ['class' => 'form-control', 'id' => 'rf_balcon2']) !!}
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::file('rf_balcon3', ['class' => 'form-control', 'id' => 'rf_balcon3']) !!}
