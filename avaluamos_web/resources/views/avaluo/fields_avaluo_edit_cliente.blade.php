    ...
    <div id="div_ppal_cliente_visita" class="border border-dark-subtle w-100 mx-auto p-5 rounded-4">
        ...
        <div class="row mb-1 mt-5" id="div_editar_cliente">
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::text('cli_nombres', null, ['class' => 'form-control text-uppercase', 'id' => 'cli_nombres', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('cli_tipo_doc',  collect(['' => 'Seleccionar...'])->union($tipo_documento), null, ['class' => 'form-control select2', 'id' => 'cli_tipo_doc', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::text('doc_cliente', null, ['class' => 'form-control text-uppercase', 'id' => 'doc_cliente', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::date('fecha_nacimiento', null, ['class' => 'form-control text-uppercase', 'id' => 'doc_cliente']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::text('cli_celular', null, ['class' => 'form-control text-uppercase', 'id' => 'cli_celular', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="">
                <div class="form-group">
                    ...
                    {!! Form::email('cli_correo', null, ['class' => 'form-control', 'id' => 'cli_correo', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="">
                <div class="form-group">
                    ...
                    {!! Form::select('tipo_persona', collect(['' => 'Seleccionar...'])->union($tipo_persona), null, ['class' => 'form-control select2', 'id' => 'tipo_persona', 'required']) !!}
                </div>
            </div>
        ...
        <div class="col-12 col-md-3" id="">
            <div class="form-group">
                ...
                {!! Form::select('cli_pais', collect(['' => 'Seleccionar...'])->union($paises), null, ['class' => 'form-control select2', 'id' => 'cli_pais']) !!}
            </div>
        </div>
        ...
        <div class="col-12 col-md-3" id="">
            <div class="form-group">
                ...
                {!! Form::select('cli_dpto', collect(['' => 'Seleccionar...'])->union($departamentos), null, ['class' => 'form-control select2', 'id' => 'cli_dpto']) !!}
            </div>
        </div>
        ...
        <div class="col-12 col-md-3" id="">
            <div class="form-group">
                ...
                {!! Form::select('cli_ciudad', collect(['' => 'Seleccionar...'])->union($ciudades), null, ['class' => 'form-control select2', 'id' => 'cli_ciudad', 'required']) !!}
            </div>
        </div>
        ...
        {{-- ======================= --}}
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('referido_por', collect(['' => 'Seleccionar...'])->union($referido_por), null, ['class' => 'form-control select2', 'id' => 'referido_por', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_red_social">
                <div class="form-group">
                    ...
                    {!! Form::select('red_social', collect(['' => 'Seleccionar...'])->union($red_social), null, ['class' => 'form-control select2', 'id' => 'red_social']) !!}
                </div>
            </div>
