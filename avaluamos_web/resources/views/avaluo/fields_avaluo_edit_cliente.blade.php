    ...
    <div id="div_ppal_cliente_visita" class="border border-dark-subtle w-100 mx-auto p-5 rounded-4">
        ...
        <div class="row mb-1 mt-5" id="div_editar_cliente">
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {{-- {!! Form::select('cli_tipo_doc',  collect(['' => 'Seleccionar...'])->union($tipo_documento), isset($calcularAvaluo) ? $calcularAvaluo->tipoDocCliente->id_tipo_documento : null, ['class' => 'form-control', 'id' => 'cli_tipo_doc', 'required']) !!} --}}
                    {!! Form::select('cli_tipo_doc',  collect(['' => 'Seleccionar...'])->union($tipo_documento), isset($calcularAvaluo) ? $calcularAvaluo->id_doc_cliente : null, ['class' => 'form-control', 'id' => 'cli_tipo_doc', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="">
                <div class="form-group">
                    ...
                    {!! Form::select('tipo_persona', collect(['' => 'Seleccionar...'])->union($tipo_persona), isset($calcularAvaluo) ? $calcularAvaluo->id_tipo_persona : null, ['class' => 'form-control', 'id' => 'tipo_persona', 'required']) !!}
                </div>
            </div>
        ...
        <div class="col-12 col-md-3" id="">
            <div class="form-group">
                ...
                {!! Form::select('cli_pais', collect(['' => 'Seleccionar...'])->union($paises), isset($calcularAvaluo) ? $calcularAvaluo->cli_pais : null, ['class' => 'form-control', 'id' => 'cli_pais']) !!}
            </div>
        </div>
        ...
        <div class="col-12 col-md-3" id="">
            <div class="form-group">
                ...
                {!! Form::select('cli_dpto', collect(['' => 'Seleccionar...'])->union($departamentos), isset($calcularAvaluo) ? $calcularAvaluo->cli_dpto : null, ['class' => 'form-control', 'id' => 'cli_dpto']) !!}
            </div>
        </div>
        ...
        <div class="col-12 col-md-3" id="">
            <div class="form-group">
                ...
                {!! Form::select('cli_ciudad', collect(['' => 'Seleccionar...'])->union($ciudades), isset($calcularAvaluo) ? $calcularAvaluo->cli_ciudad : null, ['class' => 'form-control', 'id' => 'cli_ciudad', 'required']) !!}
            </div>
        </div>
        ...
        {{-- ======================= --}}
            ...
            <div class="col-12 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('referido_por', collect(['' => 'Seleccionar...'])->union($referido_por), isset($calcularAvaluo) ? $calcularAvaluo->id_referido_por : null, ['class' => 'form-control', 'id' => 'referido_por', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_red_social">
                <div class="form-group">
                    ...
                    {!! Form::select('red_social', collect(['' => 'Seleccionar...'])->union($red_social), isset($calcularAvaluo) ? $calcularAvaluo->id_red_social : null, ['class' => 'form-control', 'id' => 'red_social']) !!}
                </div>
            </div>
