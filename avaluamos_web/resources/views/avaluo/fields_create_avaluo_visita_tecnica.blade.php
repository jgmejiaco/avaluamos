{!! Form::open(['method' => 'POST', 'route' => ['avaluos.store'], 'class' => 'mt-5', 'autocomplete' => 'off', 'id' => 'form_crear_avaluo']) !!}
@csrf
    <div id="div_crear_visita" class="border border-dark-subtle w-100 mx-auto p-5 rounded-4">
        ...
        <div class="row mb-1" id="div_campos_cliente">
            {!! Form::hidden('id_cliente', null, ['class' => '', 'id' => 'id_cliente']) !!}
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('cli_nombres', null, ['class' => 'form-control text-uppercase', 'id' => 'cli_nombres', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('id_doc_cliente', null, ['class' => 'form-control', 'id' => 'id_doc_cliente', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('documento_cliente', null, ['class' => 'form-control text-uppercase', 'id' => 'documento_cliente', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('fecha_nacimiento', null, ['class' => 'form-control text-uppercase', 'id' => 'documento_cliente', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('celular', null, ['class' => 'form-control text-uppercase', 'id' => 'celular', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_correo">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::email('correo', null, ['class' => 'form-control', 'id' => 'correo', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_correo">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('tipo_persona', null, ['class' => 'form-control', 'id' => 'tipo_persona', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('id_referido_por', null, ['class' => 'form-control', 'id' => 'id_referido_por', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_red_social">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('id_red_social', null, ['class' => 'form-control', 'id' => 'id_red_social', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_nombre_refiere">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('nombre_quien_refiere', null, ['class' => 'form-control text-uppercase', 'id' => 'nombre_quien_refiere', 'readonly' => 'true']) !!}
                </div>
            </div>
            ...
            <div class="col-12 col-md-3" id="div_empresa_refiere">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::text('empresa_que_refiere', null, ['class' => 'form-control text-uppercase', 'id' => 'empresa_que_refiere', 'readonly' => 'true']) !!}
                </div>
            </div>
        ...
        <div class="row mb-1" id="div_ubicacion_detalles">
            ...
            <div class="col-12 col-md-3">
                <div class="form-group d-flex flex-column">
                    ...
                    {!! Form::select('visitado', collect(['' => 'Seleccionar...'])->union($si_no), null, ['class' => 'form-control select2', 'id' => 'visitado', 'required']) !!}
                </div>
            </div>
