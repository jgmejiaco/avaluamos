{!! Form::open(['method' => 'POST', 'route' => ['avaluo_obser_generales_update'], 'class' => 'mt-5', 'autocomplete' => 'off', 'id' => 'form_obser_generales']) !!}
@csrf
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <div class="form-group d-flex flex-column">
                        ...
                        {!! Form::textarea('observaciones_generales', isset($calcularAvaluo) ? $calcularAvaluo->observaciones_generales : null, ['class' => 'form-control', 'id' => 'observaciones_generales', 'required']) !!}
                    </div>
                </div>
            </div>
        </div>
